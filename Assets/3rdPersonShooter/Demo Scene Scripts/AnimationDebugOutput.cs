...
public class AnimationDebugOutput : MonoBehaviour {
	...
	void Update () 
	{
		if (Input.GetKeyDown(KeyCode.L)) {
			GetComponent<Animation>()["LocomotionSystem"].weight = (GetComponent<Animation>()["LocomotionSystem"].weight == 1 ? 0 : 1);
			Debug.Log("LocomotionSystem weight = "+GetComponent<Animation>()["LocomotionSystem"].weight);
		}
